...
class TestSendDailySummary:
    def test_success_result_completes_without_retry(self):
        """A confirmed platform success must not be retried or treated as failure."""
        os.environ[_TEST_URL_ENV] = _TEST_URL
        config = WebhookConfig(
            enabled=True,
            url_env=_TEST_URL_ENV,
