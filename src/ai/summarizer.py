...
LABELS = {
    ...
    "zh": {
        ...
        "empty_body": (
            "今日暂无高价值更新。本期坚持实战质量与 7 日行动门槛，不用低质量信息补足 20 条。\n"
        ),
    },
}
...
class DailySummarizer:
    ...
    def _format_item(
        ...
        *,
        ...
        if item.metadata.get("is_progress"):
            _title = f"[{labels['progress']}] {_title}"
        ...
        source_line = f"**{labels['source']}**: " + " \u00b7 ".join(source_parts)  # ·
